...
public class ExchangeRequestController {
    ...
    public ResponseEntity<?> createExchangeRequest(
            ...
            @RequestParam Long requestedItemId,  // This is the parameter that was missing
    ...
    public ResponseEntity<List<ExchangeRequest>> getAllRequests() {
        return ResponseEntity.ok(exchangeRequestService.getAllRequests());
    }

    @GetMapping("/status/{status}")
    public ResponseEntity<List<ExchangeRequest>> getRequestsByStatus(@PathVariable String status) {
        return ResponseEntity.ok(exchangeRequestService.getRequestsByStatus(status));
    }
